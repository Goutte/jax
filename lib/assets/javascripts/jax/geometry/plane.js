...
Jax.Geometry.Plane = (function() {
  ...
  var Plane = Jax.Class.create({
    ...
    intersectLineSegment: function(line, point) {
      var u = (bufs.lineseg_u = bufs.lineseg_u || vec3.create());
      var w = (bufs.lineseg_w = bufs.lineseg_w || vec3.create());
      u = vec3.subtract(u, line.b, line.a);
      w = vec3.subtract(w, line.a, this.point);
